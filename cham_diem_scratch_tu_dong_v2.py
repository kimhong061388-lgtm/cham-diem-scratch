...
def grade_by_logic_barem(project_data, de_thi):
    ...
    # 8. Thông báo 1 (0.5đ)
    t1 = "binh thuong" if "Đề 1" in de_thi else "binh thuong"
    ...
    # 9. Thông báo 2 (0.5đ)
    t2 = "dieu chinh" if "Đề 1" in de_thi else "dieu chinh"
    if t2 in full_txt: total_score += 0.5; report.append("✅ 9. Thông báo kết quả 2 đúng (0.5đ)")
...
if st.button("NỘP BÀI VÀ XEM ĐIỂM"):
    if ten_hs and file_sb3:
        try:
            ...
            # --- LƯU ĐIỂM (CẬP NHẬT GIỜ VIỆT NAM) ---
            try:
            ...
            st.error("Lỗi file: Không đọc được bài làm!")
    else:
